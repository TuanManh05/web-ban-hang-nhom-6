                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-inline-flex gap-1">
                                            ...
                                            <!-- Nút Xóa -->
                                            <a href="index.php?action=category-delete&id=<?= $cat['id'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này không?');" title="Xóa">
