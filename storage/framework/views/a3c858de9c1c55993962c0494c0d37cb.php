...
<body class="bg-light d-flex align-items-center justify-content-center vh-100">
    <div class="card shadow p-4" style="width: 400px; border-radius: 12px;">
        ...
        <?php if($errors->any()): ?>
            <div class="alert alert-danger p-2 small text-center"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>
...
</html><?php /**PATH D:\laragon\www\web-ban-hang-nhom-6\resources\views/login.blade.php ENDPATH**/ ?>